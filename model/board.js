...
Board.boardPost = (paramUserId, paramTitle, paramCategory, paramArticle, paramAnonymity, date, cb)=>{
...
Board.boardPut = (paramUserId, paramTitle, paramCategory, paramArticle, paramAnonymity, paramBoardId, date, cb)=>{
    if(paramUserId&&paramTitle&&paramCategory&&paramArticle&&paramAnonymity&&paramNeedId) {
        pool.getConnection(function (err, conn) {
            ...
            if (paramUserId) {
                //임시_세션의 id와 일치여부 확인
                console.dir([paramTitle, paramCategory, paramArticle, date, paramAnonymity, paramBoardId]);
